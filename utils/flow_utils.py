...
def flow_to_image(flow, convert_to_bgr=True):
    """
    Convert flow map to image for visualization.
    Args:
        flow: H x W x 2, numpy array
        convert_to_bgr: whether to convert the output image to BGR format (for OpenCV)
    Returns:
